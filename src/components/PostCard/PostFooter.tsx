...
export default function PostFooter({
  ...
  return (
    <CardFooter className='text-muted-foreground mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 px-5 pt-2 pb-4 text-sm sm:flex-nowrap'>
      <div className='flex flex-wrap items-center gap-x-4 gap-y-2'>
        ...
        {flagCount > 0 && (
          <div className='flex items-center gap-1 text-xs text-red-500'>
            ...
            Flagged by {flagCount} user{flagCount > 1 ? 's' : ''}
          </div>
        )}
      </div>
