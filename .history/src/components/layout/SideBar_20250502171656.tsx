...
export default function Sidebar() {
  return (
    <aside className='hidden h-screen w-64 flex-col border-r bg-white px-6 py-8 shadow shadow-lg md:flex dark:bg-black'>
      <div className='mb-10'>
      ...
      <nav className='flex flex-col space-y-3 text-[15px] font-medium text-gray-800'>
        <Link
          href='/dashboard'
          className='flex items-center gap-3 rounded-lg px-4 py-2 transition hover:bg-blue-50 dark:text-white'
        >
